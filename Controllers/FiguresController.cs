// zagidullin.ra: Заголовок
// zagidullin.ra: очень скудные комменты (везде)
using System;
...
namespace FiguresDotStore.Controllers
{
	...
	public class Order
	{
		...
		// zagidullin.ra: метод не используется
		// zagidullin.ra: где квадрат
		// zagidullin.ra: Что будет, если отдам "parallelogram" ?
	...
	public class Square : Figure
	{
		public override void Validate()
		{
			...
			// zagidullin.ra: Возможны проблемы c потерей точности  
			if (SideA != SideB)
				throw new InvalidOperationException("Square restrictions not met");
		}
	...
	// zagidullin.ra: возможно пригодится версионирование (в таком случае не хватает атрибута и нужно дописать шаблон)
	[ApiController]
	[Route("[controller]")]
	public class FiguresController : ControllerBase
	{
		// zagidullin.ra: А нужен ли, раз не используется? 
